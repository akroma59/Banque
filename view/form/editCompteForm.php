<!-- <form action="" method="post">
    ...
    <div class="d-flex flex-wrap">
        <div class="form-group col-10 col-md-8 col-lg-4">
            ...
            <input type="text" class="form-control" id="nom" name="nom" value="<?php //echo (isset($compte)?$compte["nom"]:"");?>">
        </div>
        <div class="form-group col-10 col-md-8 col-lg-4">
            <label for="type">Type</label>
            <input type="text" class="form-control" id="type" name="type" value="<?php //echo (isset($compte)?$compte["type"]:"");?>">
        </div>
        <div class="form-group col-10 col-md-8 col-lg-4">
